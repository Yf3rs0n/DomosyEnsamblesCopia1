...
if(!empty($_POST['consulta'])) {
    ...
    $sql = "SELECT * FROM persona WHERE id_cedula LIKE '%".$consulta."%' OR nombre LIKE '%".$consulta."%' OR apellido LIKE '%".$consulta."%' OR num_telefono LIKE '%".$consulta."%' OR num_celular LIKE '%".$consulta."%' OR direccion LIKE '%".$consulta."%'";
