...
<head>
    ...
    <link rel="stylesheet" href="css_sitio_web/style_admin_dashboard.css">
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="css_sitio_web/style_principal.css">|
</head>
...
<header id="bk" >
        <div class="fixed-top">
          <div class="container-fluid ">
            <nav class="navbar navbar-expand-md fixed-top bg-dark"><!--Para que el menu quede fijo en la parte de arriba ala hora de hacer scroll -->
                <img  class="bi me-3" width="32" height="32" src="../images/po.ico" alt="">
      ...
      <div class="contenido-ad">
        <div class="cards-ad">
            <div class="card-ad">
                <div class="box-ad">
                    <h3><a class="a-ad" href="#">Personas</a></h3>
                </div>
            ...
            <div class="card-ad">
                <div class="box-ad">
                    <h3><a class="a-ad" href="#">Agendas</a></h3>
                </div>
                <div class="icon-case-ad">
